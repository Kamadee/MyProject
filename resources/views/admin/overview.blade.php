            ...
            <div class="container-xl">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-6 col-lg-3">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="stats-figure">${{ number_format($totalRevenue, 0) }}</div>
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="stats-figure">{{ $totalCustomer }}</div>
                                <div class="stats-meta text-success">
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                <h4 class="stats-type mb-1">Order Completed</h4>
                                <div class="stats-figure">{{ $orderCompleted }}</div>
                        ...
                        <div class="app-card app-card-chart h-100 shadow-sm">
                            <div class="app-card-header p-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <h4 class="app-card-title">Revenue data table</h4>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="app-card app-card-chart h-100 shadow-sm">
                            <div class="app-card-header p-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <h4 class="app-card-title">Data table of popular product categories</h4>
                                    </div><!--//col-->
                                    <div class="col-auto">
                                        <div class="card-header-action">
                                            <a href="charts.html">More charts</a>
...
<script>
    // Biểu đồ 1
    const yFixedValues = [0, 2e6, 4e6, 6e6, 8e6, 10e6, 12e6];
    const monthlyRevenue = JSON.parse('{!! $monthlyRevenue !!}'); // Tổng doanh thu từng tháng
    const xValues = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    const barColors = "#128c54";
    ...
    new Chart("myChart", {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: monthlyRevenue // Doanh thu của từng tháng
            }]
        },
        options: {
            responsive: true,
            ...
            scales: {
                ...
                y: {
                    ticks: {
                        stepSize: 2e6, // Tăng theo bậc 2 triệu
                    ...
                    suggestedMax: Math.max(...yFixedValues) // Đặt chiều cao trục y tối đa
                }
            }
        }
    });
    ...
    // Biểu đồ 2
    const xValues1 = ["Jacket", "Sweater", "Flannel", "T-shirt", "Bomber"];
