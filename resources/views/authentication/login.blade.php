...
<body>
    <section class="section bg-dark py-3 py-md-5 py-xl-8">
        <div class="container">
                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-4">
                                        <h3>Sign in</h3>
                                        <p>Don't have an account? <a href="{{ route('authentication.register') }}">Sign up</a></p>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    togglePassword.addEventListener('click', function() {
        // Toggle type attribute giữa 'password' và 'text'
        const type = password.getAttribute('type') === 'password' ? 'text' : 'password';
        password.setAttribute('type', type);

        // Toggle class của biểu tượng con mắt
