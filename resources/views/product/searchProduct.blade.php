...
@section('content')
<div class="d-flex search-product-wrapper">
    <div class="sidebar-search">
        <form action="{{ route('product.listSearch') }}" method="POST">
            ...
            <div id="accordion">
                            ...
                            <ul class="option-filter-list">
                                ...
                                <li class="option-choice">
                                    <input type="checkbox" <?php
                                                            if (isset($searchForm['size']) && in_array($size->size, $searchForm['size'])) {
                                                            ?> checked="true" <?php
                                                                            }
                                                                                ?> value="{{ $size->size }}" name="size[]" class="checkbox" />
                                    <span>{{ $size->size }}</span>
                                </li>
                                @endforeach
                ...
                <div class="card  border-0">
                    <a data-bs-toggle="collapse" data-bs-target="#product-type" role="button" aria-expanded="false" aria-controls="product-type">
                        <div class="card-header bg-white d-flex justify-content-between  border-0" id="headingOne">
                            <div class="size">
                                <h4>Brand</h4>
                            </div>
                    ...
                    <div id="product-type" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            <ul class="option-filter-list">
                                @foreach($brandList as $brand)
                                <li class="option-choice">
                                    <input type="checkbox" <?php
                                                            if (isset($searchForm['brand']) && in_array($brand->brand, $searchForm['brand'])) {
                                                            ?> checked="true" <?php
                                                                            }
                                                                                ?> value="{{ $brand->brand }}" name="brand[]" class="checkbox" />
                ...
                <div class="card  border-0">
                    <a data-bs-toggle="collapse" data-bs-target="#price-range" role="button" aria-expanded="false" aria-controls="price-range">
                        <div class="card-header bg-white d-flex justify-content-between  border-0" id="headingOne">
                            <div class="size">
                                <h4>Price range</h4>
                            </div>
                    ...
                    <div id="price-range" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            <div class="">
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <div class="d-flex justify-content-between gap-2">
                                    <div class="d-flex flex-column">
                                        <div>Min</div>
                                        <input name="minRange" id="slider-range-value1" class="form-control" />
                                        <!-- <strong>Min:</strong> <span ></span> -->
                                    </div>
                                    <div class="d-flex flex-column">
                                        <div>Max</div>
                                        <input name="maxRange" id="slider-range-value2" class="form-control" />
                ...
                <div class="card border-0">
                    ...
                    <div id="rating" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            <ul class="option-filter-list">
                                <li class="option-choice">
    ...
    <div class="container">
        <!-- <div class="box-type">
            <ul class="effect">
                ...
                <li>
                    <div class="dropdown">
                        <button class="dropdown-toggle" onclick="toggleDropdown()">Feature</button>
        ...
        <!-- <div class="box_classify">
            <div class="box_classify-title">1975,GPMN</div>
            <div class="box-classify_detail">
                <ul class="box_classify-list">
                    <li class="box_classify-item">
                    ...
                    <li class="box_classify-item" style="padding: 10px 24px"><img src="{{ asset('images/icons/btn-group.png') }}"></li>
                </ul>
            </div>
        </div> -->
        <!--  -->
        <div class="content-product">
            <div class="d-flex justify-content-between card-list">
                <div class="row">
                    ...
                    <div class="d-flex col-4 flex-column product">
...
<script>
    ...
    // Code phần thanh range min max giá sản phẩm //
